...
_inst_item_inventory = instance_create_depth((camera.x * 2 + 16 + 6 + 46 + 635), (camera.y * 2 + 16 + 6 + 50), 0, text_typer);
...
_inst_item_box = instance_create_depth((camera.x * 2 + 16 + 6 + 46 + 302 + 635), (camera.y * 2 + 16 + 6 + 50), 0, text_typer);
