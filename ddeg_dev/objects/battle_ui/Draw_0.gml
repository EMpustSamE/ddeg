...
draw_text_ext_transformed_color(x,y,Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.NAME)+"   LV "+string(Player_GetLv()),-1,-1,1,1,0,_color,_color,_color,_color,1);
draw_sprite_ext(spr_battle_ui_hp,0,x+214,y+4,1,1,0,_color,1);
