...
_inst_name=instance_create_depth(23+_offset+camera.x,(52+6+(_top ? 270 : 0)+2)/2+camera.y,0,text_typer);
_inst_name.text=_prefix+Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.NAME);
_destroy_time=array_create(3,0)
_inst_menu=instance_create_depth(_offset+(32+6+46)/2+camera.x,(168+6+14)/2+camera.y,0,text_typer);
